...
import { TASK_CLEANUP_FAILURES, TASK_CLEANUP_TOOL, type TaskCleanupToolName } from "./cleanup.tool.schema.js";
...
// 후보 목록을 훑고 무엇을 조사할지 정하는 데 예약해 두는 턴이다.
...
// 선별만 후보 목록을 가지고 검토 전문가만 이벤트를 연다.
