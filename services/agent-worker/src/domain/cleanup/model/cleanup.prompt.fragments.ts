...
function cleanupFragment(slot: keyof typeof CLEANUP_FRAGMENT_DEFAULTS, fragmentKey: string) {
...
export const CLEANUP_REVIEW_GUARANTEE = cleanupFragment("reviewGuarantee", "review-guarantee");
export const CLEANUP_REVIEWER_SOURCING = cleanupFragment("reviewerSourcing", "reviewer-sourcing");
export const CLEANUP_EVIDENCE_DISCIPLINE = cleanupFragment("evidenceDiscipline", "evidence-discipline");
export const CLEANUP_SUGGESTION_RULES = cleanupFragment("suggestionRules", "suggestion-rules");
export const CLEANUP_REDISPATCH_PROTOCOL = cleanupFragment("redispatchProtocol", "redispatch-protocol");
export const CLEANUP_REPAIR_DIRECTIVE = cleanupFragment("repairDirective", "repair-directive");
export const CLEANUP_CANDIDATE_FIELDS = cleanupFragment("candidateFields", "candidate-fields");
export const CLEANUP_TRIAGE_POLICY = cleanupFragment("triagePolicy", "triage-policy");
export const CLEANUP_INSPECT_WEIGHTING = cleanupFragment("inspectWeighting", "inspect-weighting");
export const CLEANUP_REVIEWER_CHARTER = cleanupFragment("reviewerCharter", "reviewer-charter");
