...
export const RECIPE_ANCHOR: RecipeAnchorContract["requires"] = readContractJson<{
    readonly anchor: RecipeAnchorContract;
}>(`agent/${RECIPE_FEATURE}/agent.json`).anchor.requires;
